...
<head>
	...
	<title>Temperatuur Verloop</title>
				...
				<div class="row">
					...
					<div class="large-5 columns">
						...
						<div class="row location-name">
							<div class="large-4 columns"><strong>Naam</strong></div>
							<div class="large-8 columns value"></div>
						</div>
				...
				<div class="row">
					<div class="large-12 columns">
						<div class="button-group" style="float: right;">
							<a href="#" class="small button secondary duration-hour">6 Uur</a>
							<a href="#" class="small button secondary duration-day">Dag</a>
							<a href="#" class="small button secondary duration-week">Week</a>
							<a href="#" class="small button secondary duration-month">Maand</a>
							<a href="#" class="small button secondary duration-90">90 Dagen</a>
							<a href="#" class="small button secondary duration-1year">Jaar</a>
						</div>
					</div>
				</div>
				<div class="row">
								...
								<div class="row">
									<div class="large-12 columns">
										<div class="graphWrapper" style="margin-top: 15px; padding: 10px; text-align: center;">
											<div class="graph" style="width: 500px; margin: auto;"></div>
										</div>
										<div class="slider" style="width: 500px; height: 15px; margin: auto;"></div>
									</div>
								</div>
							</div>
						</div>
